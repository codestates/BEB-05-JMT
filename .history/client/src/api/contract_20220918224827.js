...
const _fetchCharacter = async (charId) => {
    ...
    const tokenURI = await NFTContract.methods.tokenURI(charId).call(); tokenURI.replace("https://ipfs.io/ipfs/", "https://gateway.pinata.cloud/ipfs/");
...
const addCharacterOnSale = async(tokenId, myAddr, price) =>{
