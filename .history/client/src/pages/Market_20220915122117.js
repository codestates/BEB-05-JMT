  ...
  return (
    <div>
      <div className="ranking-container">
        ...
        <div class="tab">
          <button class="tablinks" onclick="itemList(event, 'London')">London</button>
          <button class="tablinks" onclick="itemList(event, 'Paris')">Paris</button>
          <button class="tablinks" onclick="itemList(event, 'Tokyo')">Tokyo</button>
        </div>
